        ...
        <div className='mt-10 justify-between gap-8 md:flex'>
          ...
          <motion.div
            ...
            <form
              ...
              <button
                type='submit'
                className='mt-5 rounded-lg bg-secondary-500 px-20 py-3 cursor-pointer transition duration-500 hover:bg-primary-500 hover:text-white'>
                SUBMIT
              </button>
            </form>
          </motion.div>
          ...
          <motion.div className='relative mt-16 basis-2/5 md:mt-0'>
            <div className='w-full before:absolute before:-bottom-20 before:-right-10 z-[-1] md:before:content-evolvetext'>
              <img
                className='w-full'
